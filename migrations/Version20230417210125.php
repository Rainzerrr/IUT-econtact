 ...
 */
final class Version20230417210125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contacts ADD id INT AUTO_INCREMENT NOT NULL, ADD user_id INT NOT NULL, ADD contact_id INT NOT NULL, DROP userId, DROP contactId, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contacts ADD userId INT NOT NULL, ADD contactId INT NOT NULL, DROP id, DROP user_id, DROP contact_id');
