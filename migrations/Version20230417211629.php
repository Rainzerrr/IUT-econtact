 ...
 */
final class Version20230417211629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contacts ADD user INT NOT NULL, ADD contact INT NOT NULL, DROP userId, DROP contactId, ADD PRIMARY KEY (user, contact)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contacts ADD userId INT NOT NULL, ADD contactId INT NOT NULL, DROP user, DROP contact');
